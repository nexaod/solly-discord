...
export const duoRoleData = [
    {
        role: `duoRootskips`,
        timeExpectation: `Sub **7:00** kills. (Necro / ${Emojis.ranged}/${Emojis.magic})`,
