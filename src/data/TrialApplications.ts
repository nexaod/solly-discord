...
export const groupRoleData = [
    ...
    },
    {
        ...
        requirements: `⬥ ${Emojis.shard} twice in Phase 1.\n\u200B⬥ Prebuild with ${Emojis.nati} and ${Emojis.greaterSun} at 58 seconds with pre ${Emojis.fsoa} ${Emojis.spec} before arms.\n\u200B⬥ ${Emojis.greaterChain} and ${Emojis.nami} first two abilities on arms.\n\u200B⬥ Phase 1 core exit by **1:36**.\n\u200B⬥ Storm tanking required, ${Emojis.zerk} to finish eruption within 5 GCDs.\n\u200B⬥ Phase into Phase 3 before any rain hits.\n\u200B⬥ Adrenaline should be managed to ensure ${Emojis.zerk} can be used at the start of Phase 3.\n\u200B⬥ Phase 3 should be 2 padded at max, no stalling inbetween pads.\n\u200B⬥ ${Emojis.nati} should be used at the end of Phase 3 for a better Phase 4 rotation.`,
    ...
    },
    {
        ...
        timeExpectation: `Sub **3:55** kills.`,
        requirements: `⬥ Arms require a stalled ${Emojis.greaterChain} or ${Emojis.nami} released with ${Emojis.nami} or ${Emojis.greaterChain} respectively.\n\u200B⬥ ${Emojis.p6} ${Emojis.c1} on ${Emojis.inquis}.\n\u200B⬥ ${Emojis.dummy} dropped for legs.\n\u200B⬥ Phase 1 core exit by **1:31**.\n\u200B⬥ ${Emojis.zerk} to finish eruption within 5 GCDs.\n\u200B⬥ Place 1 ${Emojis.dummy} on Phase 2, and everyone place a ${Emojis.dummy} on Phase 3.\n\u200B⬥ A late ${Emojis.nami} in Phase 2 to ensure Phase 3 ${Emojis.zerk} ${Emojis.critBuff}.\n\u200B⬥ ${Emojis.meteor} in Phase 3 ${Emojis.zerk} is required for a late ${Emojis.nami}.\n\u200B⬥ Solak must be capped by the time the second pad has charged on Phase 3.`,
        obtaining: `⬥ This role can be obtained through a VoD review.\n\u200B⬥ This role can be obtain through a trial.`,
    },
    {
        role: `fours`,
