...
export const duoRoleData = [
    ...
    },
    {
        ...
        requirements: `⬥ Minimum of 40 (80%) ${Emojis.evolvToxin} stacks per Ranger at the time of rootskip.\n\u200B⬥ A prebuild for legs is required (${Emojis.nati} or ${Emojis.deathspore} ${Emojis.incend} / ${Emojis.nami}) with ${Emojis.greaterDeathSwiftness} placed within 1 GCD of Arms spawn.\n\u200B⬥ ${Emojis.fulArrow} utilized on arms, legs and core with a solid rotation that allows for consistent 1 cycle cores regardless of when your partner ultimates.\n\u200B⬥ Phase 1 core exit by **1:56**.\n\u200B⬥ Eruptions should be completed solo, with both south eruptions dying before cleanse, and north within 5 GCDs.\n\u200B⬥ ${Emojis.deathspore} ${Emojis.incend} / ${Emojis.nami} for a crit buffed Phase 2 ${Emojis.greaterDeathSwiftness}.\n\u200B⬥ Minimum of 65 (130%) ${Emojis.evolvToxin} stacks per Ranger at the time of Phase 2 ${Emojis.greaterDeathSwiftness}.\n\u200B⬥ Phase into Phase 3 with before the 3rd rain hit.\n\u200B⬥ Minimum 100 (200%) ${Emojis.evolvToxin} stacks per Ranger at the time of Phase 2 Cap.\n\u200B⬥ Prebuilding with with a ${Emojis.dummy} in Phase 4 is required.`,
        obtaining: `⬥ This role is vouchable by anyone with ${Roles.duoExperienced}+.\n\u200B⬥ This role can be obtained through a VoD review.\n\u200B⬥ This role can be obtained through a trial.`,
        kph: `This role expects 7 KPH.`,
    },
    {
